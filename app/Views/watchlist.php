...
<h1 class="text-center text-success">WATCH LIST</h1>
<div class="d-flex justify-content-center gap-1 mb-3">
    <a href="/watchlist" class="btn btn-outline-success rounded-5">All</a>
    <a href="/watchlist/movie" class="btn btn-outline-success rounded-5">Movies</a>
    <a href="/watchlist/videoGame" class="btn btn-outline-success rounded-5">Video Games</a>
    <a href="/watchlist/tvSeries" class="btn btn-outline-success rounded-5">Tv Series</a>
</div>
<div class="container">
    <div class="row row-cols-sm-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4">
        <?php foreach ($data as $row) : ?>
            <div class="col mb-3">
                ...
                <a href="/search/<?= $row['imdbId'] ?>" class="underlinedlink-offset-2 link-underline link-underline-opacity-0 text-center d-block my-2 text-success">
